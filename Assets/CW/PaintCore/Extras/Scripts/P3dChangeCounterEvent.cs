...
namespace PaintIn3D
{
	...
	public class P3dChangeCounterEvent : MonoBehaviour
	{
		...
		/// <summary>This allows you to listen to the current paint ratio of the specified <b>Color</b>, where 0 is no paint, and 1 is fully painted.</summary>
		public System.Action<float> OnRatioChanged;
