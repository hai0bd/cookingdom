...
public static class HandlesExtended
{
    ...
    public static void DrawScaledCap(Handles.CapFunction capFunction, Vector3 center, Quaternion rotation, Vector3 scale, float size, Color color)
    {
        Handles.color = color;
        ...
        {
            capFunction(0, center, rotation, size, EventType.Repaint);
        }
    }
	...
	public static void DrawRectange(Vector3 center, Quaternion rotation, Vector3 scale, float size) { DrawRectange(center, rotation, scale, size, Handles.color); }
    ...
    public static void DrawRectange(Vector3 center, Quaternion rotation, Vector3 scale, float size, Color color)
    {
        DrawScaledCap(Handles.RectangleHandleCap, center, rotation, scale, size, color);
    }
