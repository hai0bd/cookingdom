...
{
#if UNITY_EDITOR
    public static class SerializedComponentCopyUtil
    {
        ...
        public static void PasteSerializedFromBase(MenuCommand command)
        {
            ...
            //jump into serialized object, t$$anonymous$$s will skip script type so that we dont override the destination component's type
