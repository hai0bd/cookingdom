...
namespace Utilities
{
    ...
    public class SceneViewCamera3D : MonoBehaviour
    {
        ...
        [SerializeField] private KeyCode ascendButton = KeyCode.E;
        [SerializeField] private KeyCode descendButton = KeyCode.Q;
        ...
        private void Update()
        {
            ...
            if (allowMovement)
            {
                ...
                CheckMove(ascendButton, ref deltaPosition, transform.up, false, false);
                CheckMove(descendButton, ref deltaPosition, -transform.up, false, false);
